...
python3 train.py --train_path "/media/valia/TOSHIBA EXT/datasets/msc/cifar-10-python/cifar-10-batches-py" --dataset "CIFAR10" --grid_search --reduced_training_dataset --use_PCA --train_experiment_name "TESTDELETE"
